...
<body id="body">
    ...
    <p id="paragraphFour" onmouseover="mouseOverFunction(this)">
...
        I want to click anywhere in this paragraph tag and I want to be able to change the background color to whatever is in this input: <input id="color" type="text"/>.
    ...
    <script>
        ...
        document.getElementByID("paragraphFour").onlcick = () => setBackgroundColorById( "paragraphFour", getValueFromId(`color`));
            
        getValueFromId = (id) => document.getElementById(id).vlaue
